...
EGO_VEHICLE_ID = '47b529db-0593-4908-b3e7-4b24a32a0f70'

class Simulator(object):

    def __init__(self, default_record_folder, target_record_folder, total_sim_time, lgsvl_map = '12da60a7-2fc9-474d-a62a-5cc08cb97fe8', apollo_map = 'San Francisco Correct'):
    ...
    def load_map(self, mapName="12da60a7-2fc9-474d-a62a-5cc08cb97fe8"):
    ...
    def runSimulation(self, scenario_obj, json_file, case_id):
        ...
        while times < 3:
            try:
                ...
                # print("Map and Vehicle set")
                dv.disable_apollo()
                # print("Apollo disabled")
                dv.setup_apollo(destination.position.x, destination.position.z, modules)
                success = True
                # print("Apollo connected")
                break
            except:
        ...
        # print(simulation_recording)

        return result_dict, simulation_recording